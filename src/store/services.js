...
export const useServicesStore = defineStore('services', {
  state: () => ({
    services: [
      ...
      { id: 4, name: 'Formaturas', description: 'Organização impecável para sua celebração.', icon: 'pi pi-book' },
      { id: 5, name: 'Shows e Festivais', description: 'Produção de eventos musicais de grande porte.', icon: 'pi pi-ticket' },
